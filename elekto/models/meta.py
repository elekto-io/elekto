...
class Election(Meta):
    ...
    def showfields(self):
        # FIXME: show_candidate_fields could be None (as is the case in the name_the_app example meta), leading to anAdd commentMore actions
        #  error if showfields() is called.
